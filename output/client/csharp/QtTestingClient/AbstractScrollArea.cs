...
using static Org.Whatever.QtTesting.Frame;

namespace Org.Whatever.QtTesting
{
    public static class AbstractScrollArea
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void ScrollBarPolicy__Push(ScrollBarPolicy value)
        {
            NativeImplClient.PushInt32((int)value);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static ScrollBarPolicy ScrollBarPolicy__Pop()
        {
            var ret = NativeImplClient.PopInt32();
        ...
        public class Handle : Frame.Handle
        {
            ...
            public void SetHorizontalScrollBarPolicy(ScrollBarPolicy policy)
            {
                ...
                Handle__Push(this);
                NativeImplClient.InvokeModuleMethod(_handle_setHorizontalScrollBarPolicy);
            }
            ...
            public void SetVerticalScrollBarPolicy(ScrollBarPolicy policy)
            {
                ScrollBarPolicy__Push(policy);
                Handle__Push(this);
                NativeImplClient.InvokeModuleMethod(_handle_setVerticalScrollBarPolicy);
            }
        }
        ...
        {
            _module = NativeImplClient.GetModule("AbstractScrollArea");
