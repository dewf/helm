...
using static Org.Whatever.QtTesting.DockWidget;
using static Org.Whatever.QtTesting.Enums;
using static Org.Whatever.QtTesting.ToolBar;
using static Org.Whatever.QtTesting.StatusBar;
using static Org.Whatever.QtTesting.TabWidget;
