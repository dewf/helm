...
using static Org.Whatever.QtTesting.AbstractButton;
...
namespace Org.Whatever.QtTesting
{
    public static class PushButton
    {
        ...
        internal static ModuleMethodHandle _handle_setAutoDefault;
        internal static ModuleMethodHandle _handle_setDefault;
        ...
        public class Handle : AbstractButton.Handle
        {
            ...
            public void SetAutoDefault(bool value)
            {
                NativeImplClient.PushBool(value);
                Handle__Push(this);
                NativeImplClient.InvokeModuleMethod(_handle_setAutoDefault);
            }
            public void SetDefault(bool value)
            {
                NativeImplClient.PushBool(value);
                Handle__Push(this);
                NativeImplClient.InvokeModuleMethod(_handle_setDefault);
            }
            public void SetFlat(bool value)
            {
                NativeImplClient.PushBool(value);
                Handle__Push(this);
        ...
        internal static void __Init()
        {
            ...
            _handle_setAutoDefault = NativeImplClient.GetModuleMethod(_module, "Handle_setAutoDefault");
            _handle_setDefault = NativeImplClient.GetModuleMethod(_module, "Handle_setDefault");
