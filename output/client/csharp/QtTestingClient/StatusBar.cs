...
using static Org.Whatever.QtTesting.Object;
using static Org.Whatever.QtTesting.Common;
using static Org.Whatever.QtTesting.Icon;
...
namespace Org.Whatever.QtTesting
{
    public static class StatusBar
    {
        ...
        internal static ModuleMethodHandle _handle_isSizeGripEnabled;
        internal static ModuleMethodHandle _handle_setSizeGripEnabled;
        internal static ModuleMethodHandle _handle_clearMessage;
        internal static ModuleMethodHandle _handle_showMessage;
        ...
        internal static InterfaceMethodHandle _signalHandler_messageChanged;
        ...
        private class ServerSignalHandler : ServerObject, SignalHandler
        {
            ...
            {
                NativeImplClient.PushString(message);
                NativeImplClient.InvokeInterfaceMethod(_signalHandler_messageChanged, Id);
            }
        ...
        public class Handle : Widget.Handle
        {
            ...
            {
                Handle__Push(this);
                NativeImplClient.InvokeModuleMethod(_handle_isSizeGripEnabled);
            ...
            {
                Handle__Push(this);
                NativeImplClient.InvokeModuleMethod(_handle_clearMessage);
            }
            public void ShowMessage(string message, int timeout)
            {
                NativeImplClient.PushInt32(timeout);
                NativeImplClient.PushString(message);
                Handle__Push(this);
                NativeImplClient.InvokeModuleMethod(_handle_showMessage);
            }
        ...
        {
            _module = NativeImplClient.GetModule("StatusBar");
            // assign module handles
            _create = NativeImplClient.GetModuleMethod(_module, "create");
            _handle_isSizeGripEnabled = NativeImplClient.GetModuleMethod(_module, "Handle_isSizeGripEnabled");
            _handle_setSizeGripEnabled = NativeImplClient.GetModuleMethod(_module, "Handle_setSizeGripEnabled");
            _handle_clearMessage = NativeImplClient.GetModuleMethod(_module, "Handle_clearMessage");
            _handle_showMessage = NativeImplClient.GetModuleMethod(_module, "Handle_showMessage");
            ...
            _signalHandler_messageChanged = NativeImplClient.GetInterfaceMethod(_signalHandler, "messageChanged");
            ...
            NativeImplClient.SetClientMethodWrapper(_signalHandler_messageChanged, delegate(ClientObject __obj)
            {
                var inst = ((__SignalHandlerWrapper)__obj).RawInterface;
