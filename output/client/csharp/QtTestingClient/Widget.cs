...
using static Org.Whatever.QtTesting.Painter;
...
using static Org.Whatever.QtTesting.Region;
using static Org.Whatever.QtTesting.Cursor;
using static Org.Whatever.QtTesting.SizePolicy;
